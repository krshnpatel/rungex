...
var plugin = (() => {
  ...
  var require_conversions = __commonJS({
    ".yarn/cache/color-convert-npm-2.0.1-79730e935b-79e6bdb9fd.zip/node_modules/color-convert/conversions.js"(exports, module) {
  ...
  var require_route = __commonJS({
    ".yarn/cache/color-convert-npm-2.0.1-79730e935b-79e6bdb9fd.zip/node_modules/color-convert/route.js"(exports, module) {
  ...
  var require_color_convert = __commonJS({
    ".yarn/cache/color-convert-npm-2.0.1-79730e935b-79e6bdb9fd.zip/node_modules/color-convert/index.js"(exports, module) {
      var conversions = require_conversions();
  ...
  var require_ansi_styles = __commonJS({
    ".yarn/cache/ansi-styles-npm-4.3.0-245c7d42c7-513b44c3b2.zip/node_modules/ansi-styles/index.js"(exports, module) {
      "use strict";
  ...
  var require_has_flag = __commonJS({
    ".yarn/cache/has-flag-npm-4.0.0-32af9f0536-261a135703.zip/node_modules/has-flag/index.js"(exports, module) {
      "use strict";
  ...
  var require_supports_color = __commonJS({
    ".yarn/cache/supports-color-npm-7.2.0-606bfcf7da-3dda818de0.zip/node_modules/supports-color/index.js"(exports, module) {
      "use strict";
      var os = __require("os");
  ...
  var require_util = __commonJS({
    ".yarn/cache/chalk-npm-4.1.2-ba8b67ab80-fe75c9d5c7.zip/node_modules/chalk/source/util.js"(exports, module) {
      "use strict";
  ...
  var require_templates = __commonJS({
    ".yarn/cache/chalk-npm-4.1.2-ba8b67ab80-fe75c9d5c7.zip/node_modules/chalk/source/templates.js"(exports, module) {
      "use strict";
  ...
  var require_source = __commonJS({
    ".yarn/cache/chalk-npm-4.1.2-ba8b67ab80-fe75c9d5c7.zip/node_modules/chalk/source/index.js"(exports, module) {
      "use strict";
  ...
  var logger;
  var DIVIDER_LENGTH = 60;
  var END_TEXT = "DONE";
  var END_TEXT_SPACE_AROUND = 1;
  var initLogger = (writer) => {
  ...
  var Logger = class {
    ...
    divider(style = import_chalk.default.white, count = DIVIDER_LENGTH) {
...
`);
    ...
    bold(text) {
      this.logger.write(`${import_chalk.default.bold(text)}
`);
    }
    info(text) {
...
`);
    ...
    title(text, dividerLength = DIVIDER_LENGTH) {
      const spaceLength = (dividerLength - text.length) / 2;
      const spaces = " ".repeat(spaceLength);
      this.divider(import_chalk.default.blue, dividerLength);
      this.bold(`${spaces}${import_chalk.default.whiteBright(text)}`);
      this.divider(import_chalk.default.blue, dividerLength);
    }
    done() {
  ...
  var RungexCommand = class extends import_clipanion.Command {
    ...
    async getMatchingScripts() {
      const { fileName } = import_core.Manifest;
      const { scripts } = await import_core.Manifest.fromFile(fileName);
      this.log.info(`Looking for scripts in ${fileName}...`);
      if (scripts.size === 0) {
        this.log.info(
          import_chalk2.default`{red There are no scripts defined in {bold ${fileName}}.}`
        );
        return 0;
      }
      this.log.info(
      ...
      for (const script of scripts.keys()) {
        ...
        if (matched) {
          ...
          matchedScriptsText += import_chalk2.default`> {blue "${fullScript}"}\n`;
        }
      }
      if (this.matchedScripts.length === 0) {
        this.log.info(import_chalk2.default`{red There were no matched scripts to run.}`);
        return 0;
      }
      this.log.info(
    ...
    async confirm() {
      ...
      if (["y", "Y", "yes", "YES", "Yes"].includes(answer)) {
        ...
        this.log.info(import_chalk2.default.bold.red`Aborting...`);
        return 0;
      }
    }
    async runMatchedScripts() {
      ...
      if (this.parallel) {
        ...
        for (const script of this.matchedScripts) {
          ...
          await (0, import_shell.execute)(`${script} || true`);
          this.log.done();
          this.log.newLine();
        }
      }
      const totalTime = new Date().getTime() - startTime;
      this.log.info(`Executed scripts in ${totalTime / 1e3}s`);
      return 0;
    }
  };
